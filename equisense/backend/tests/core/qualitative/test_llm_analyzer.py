...
_FAKE_RESULT = {
    ...
    "noise_filter": [{"claim": "시장 1위 달성", "is_substantiated": True, "evidence": "점유율 데이터"}],
}
...
class TestAnalyzeAndSave:
    ...
    def test_calls_all_stages_in_order(
        self, mock_persist, mock_claude, mock_retrieve, mock_embed
    ):
        fake_emb = [[0.1] * 1536] * 3
