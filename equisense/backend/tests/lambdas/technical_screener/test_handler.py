...
class TestSuccess:
    def test_returns_200_when_all_screened(self):
        ...
        with patch("lambdas.technical_screener.handler.screen_all_companies", return_value=mock_result):
    ...
    def test_returns_500_on_fatal_error(self):
        ...
        with patch("lambdas.technical_screener.handler.screen_all_companies",
