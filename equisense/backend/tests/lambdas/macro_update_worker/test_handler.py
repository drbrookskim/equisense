...
class TestSuccess:
    def test_returns_200_when_all_indicators_updated(self):
        ...
        with patch("lambdas.macro_update_worker.handler.update_all_indicators", return_value=mock_result):
    ...
    def test_returns_500_on_fatal_error(self):
        ...
        with patch("lambdas.macro_update_worker.handler.update_all_indicators",
