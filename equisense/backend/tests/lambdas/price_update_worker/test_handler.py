...
from lambdas.price_update_worker.handler import lambda_handler, _get_tickers
...
class TestSuccess:
    def test_returns_200_when_all_updated(self):
        ...
        with patch("lambdas.price_update_worker.handler.update_watchlist_prices", return_value=mock_result):
    ...
    def test_returns_500_on_fatal_error(self):
        ...
        event = {"tickers": ["AAPL"]}
        with patch("lambdas.price_update_worker.handler.update_watchlist_prices",
