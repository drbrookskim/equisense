...
from lambdas.analysis_orchestrator.handler import lambda_handler, DAILY_LIMIT
...
def _event(ticker: str, market: str, fiscal_year: int = 2024, doc_type: str = "annual_report") -> dict:
    return {
